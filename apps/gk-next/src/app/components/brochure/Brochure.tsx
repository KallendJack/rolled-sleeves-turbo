...
export default function Brochure(props: BrochureProps) {
    const { title, image, description, button } = props

    return (
        <section className="pt-16 mx-auto overflow-hidden md:py-16 md:max-w-7xl lg:py-32 lg:px-8 lg:pb-48">
                    ...
                    <div className="w-full max-w-2xl -mt-16 lg:-mb-16 lg:w-96 lg:flex-none">
                        <div className="relative aspect-[2/1] h-full lg:mx-0 lg:aspect-auto">
                            <div className="absolute inset-0 object-cover w-full h-full shadow-2xl lg:w-2/6 xl:w-2/5 bg-brand-primaryBg">
                                <Image fill src={image} alt="Brochure" className="object-cover" />
                            </div>
                        </div>
                    </div>
                    <div className="z-10 w-full max-w-2xl lg:max-w-none lg:flex-auto lg:pr-6 xl:pl-40 lg:py-24">
