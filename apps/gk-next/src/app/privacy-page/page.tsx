export default function Page() {
    return (
        <>
            <section className="container py-32 space-y-2">
                <h1 className="text-4xl mb-12">Privacy Policy</h1>
                ...
                <ol className="list-decimal space-y-2">
                    <li className="text-lg font-bold">Definitions and Interpretations</li>
                    ...
                    <p className="text-lg font-bold">&quot;Cookie Law&quot;</p>
                    ...
                    <p className="text-lg font-bold">&quot;We/Us/Our&quot;</p>
                    ...
                    <li className="text-lg font-bold ">&quot;Information About Us&quot;</li>

                    <ol className=" list-inside list-decimal counter">
                        <li>
                            Our Site is owned and operated by Garrett Appliances Limited, a limited
                            company registered in England under company number 08585642, of Unit 2
                            iO Trade Centre, 57A Croydon Road, Croydon, CR0 4WQ.
                        </li>
                        <li>Our VAT number is GB 165 4164 09.</li>
                        <li>Our VAT number is GB 165 4164 09.</li>
                        <li>
                            Our Data protection Officer is Michael Garrett, and they can be
                            contacted by post at the above address.
                        </li>
                    </ol>

                    <li className="text-lg font-bold">What Does This Policy Cover?</li>
                    ...
                    <li className="text-lg font-bold">Your Rights</li>
                    ...
                    <li className="text-lg font-bold">What Data Do We collect?</li>
                    ...
                    <p>
                        ...
                        Protection Bill 2018 and GDPR at all times. For more details on security see
                        section 7, below.
                    </p>
                    ...
                    <p>
                        ...
                        unsubscribe or opt-out at any time by clicking the unsubscribe link in our
                        emails’ footers;
                    </p>
                    ...
                    <p>
                        6.2.8 Analysing your use of Our Site and gathering feedback to enable Us to
                    ...
                    <p>
                        ...
                        Protection Bill 2018 and GDPR and the Privacy and Electronic Communications
                        (EC Directive) Regulations 2003.
                    </p>

                    <p>
                        6.4 Third parties (as listed below) whose content appears on Our Site may
                        use third party Cookies, as detailed below in section 13. Please refer to
                        section 13 for more information on controlling Cookies. Please note that We
                        do not control the activities of such third parties, nor the data they
                        collect and use and advise you to check the privacy policies of any such
                        third parties.
                    </p>
                    ...
                    <p>
                        ...
                        light of the reason(s) for which it was first collected. Data will therefore
                        be retained for the following periods (or its retention will be determined
                        on the following bases):
                    </p>

                    <p>
                        6.7 Data relating to orders you have placed with Us will be held for a
                        minimum of 6 years and may be held beyond this period for the purposes of
                        marketing unless you withdraw consent thereafter.
                    </p>

                    <p>
                        6.8 Data relating to Marketing will be held for an unspecified time period
                        and only until such time as consent is withdrawn by you.
                    </p>

                    <p> </p>

                    <p>How and Where Do We Store Your Data?</p>
                    <p>
                    ...
                    <p>
                        7.3.4 Use of an encrypted password firewall for access to personal sensitive
                        data (Such as My Account and Order History)
                    </p>

                    <p>
                        7.3.5 Periodic testing of systems against known vulnerabilities such as DDOS
                        attacks or SQL injection and malware.
                    </p>

                    <p> </p>

                    <p>Do We Share Your Data?</p>
                    <p>
                    ...
                    <p>
                        ...
                        steps to ensure that your data is treated as safely and securely as it would
                        be within the UK and under the Data Protection Bill 2018 and GDPR including:
                    </p>
                    ...
                    <p>What Happens If Our Business Changes Hands?</p>
                    <p>
                        ...
                        party will, under the terms of this Privacy Policy, be permitted to use that
                    ...
                    <p>
                        ...
                        and by managing your My Account under Preferences).
                    </p>
                    ...
                    <p>How Can You Access Your Data?</p>
                    <p>
                        You have the right to ask for a copy of your personal data held by Us (where
                        such data is held and is not exempt for disclosure). Under the Data
                        Protection Bill 2018, Under the GDPR, no fee is payable for a single request
                        for data and We will provide non exempted information in response to your
                        request in the first instance. Should you wish to make such a request on
                        more than one occasion within a reasonable period, Garrett Appliances
                        Limited reserved the right to charge a nominal fee to cover Our expense in
                        providing data on subsequent occasions. This charge shall not exceed £10 for
                        the second or subsequent requests. Please contact Us for more details at
                    ...
                    <p>
                        ...
                        experience of Our Site and to provide and improve Our products and services.
                        We have carefully chosen these Cookies and have taken steps to ensure that
                        your privacy and personal data is protected and respected at all times.
                    </p>
                    ...
                    <p>
                        ...
                        Site for improving user experience, advertising services, and review
                        services. For more details, please refer to section 6 above. These Cookies
                    ...
                    <p>
                        13.3 All Cookies used by and on Our Site are used in accordance with current
                        Cookie Law.
                    </p>

                    <p>
                        13.4 Before Cookies are placed on your computer or device, you will be shown
                        a notification message requesting your consent to set those Cookies. By
                        ...
                        revoke consent to the placing of Cookies; however certain features of Our
                    ...
                    <p>
                        ...
                        sought to place these Cookies, but it is still important that you are aware
                        of them. You may still block these Cookies by changing your internet
                        browser’s settings, but please be aware that Our Site may not work properly
                        if you do so. We have taken great care to ensure that your privacy is not at
                    ...
                    <p>
                        ...
                        contact Us by post at Unit 2 iO Trade Centre, 57A Croydon Road, Croydon, CR0
                        4WQ. Please ensure that your query is clear, particularly if it is a request
                        for information about the data We hold about you (as under section 12,
                        above).
                    </p>
                    ...
                    <p>
                        15.1 We may change this Privacy Policy from time to time (for example, if
                        the law changes). Any changes will be immediately posted on Our Site and you
